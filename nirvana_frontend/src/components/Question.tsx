...
export const Question = () => {
  ...
  const suggestedActions = [
    ...
    {
      title: 'How many times does the',
      label: 'digit 1 appear between 0 and 100?',
      action: 'How many times does the digit 1 appear between 0 and 100?',
    },
  ]

  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 w-full px-4 md:px-0 mx-auto md:max-w-[500px] mb-4">
        {questionsAndAnswersCount < 2 &&
            ...
            >
              <button
                ...
                onClick={() => {
                  setQuestionsAndAnswers(prevQsAndAs =>
                    helpSetQuestionAndAnswer(prevQsAndAs, id, {
                      question: suggestedAction.action,
                    }),
                  )
                  autoGrow()
                }}
