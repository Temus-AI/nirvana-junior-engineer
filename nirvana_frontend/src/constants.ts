...
export const useSessionStorageHandle = '__reactFlowtemus__'
export const useTokenDataTransferHandle = '__reactFlowtemusToken__'
export const useSessionStorageNotesHandle = '__reactFlowtemusNotes__'
